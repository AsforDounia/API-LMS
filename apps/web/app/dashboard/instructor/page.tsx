...
import { Loader2, Plus, BookOpen, Eye, Pencil, Trash2, BarChart3, Search } from "lucide-react"
...
export default function InstructorDashboardPage() {
    ...
    const handleTogglePublish = async (courseId: string, currentStatus: boolean) => {
        try {
            const updated = await updateCourse(courseId, { isPublished: !currentStatus })
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage your courses as an instructor</p>
                </div>
                <Button asChild>
            ...
            {filteredCourses.length === 0 ? (
                <Card className="p-12 text-center">
                    ...
                    <p className="text-muted-foreground mb-4">
                        {courses.length === 0 ? "Create your first course to get started" : "Try adjusting your search or filter"}
                    </p>
                    {courses.length === 0 && (
                        <Button asChild>
                            <Link href="/dashboard/instructor/create">
                                ...
                                <div className="flex items-center gap-3 ml-4">
                                    <div className="flex items-center gap-2">
                                        <Switch
                                            ...
                                            onCheckedChange={() => handleTogglePublish(course._id, course.isPublished)}
                                        />
                                    ...
                                    <div className="flex items-center gap-1">
                                        <Button variant="ghost" size="icon" asChild>
                                            <Link href={`/dashboard/instructor/${course._id}/edit`}>
